...
int openmv_dis_x,openmv_dis_y;
float keep_openmv_xy_Kp=0.3;
int openmv_dis_x_target,openmv_dis_y_target;
int keep_openmv_dis_xy_flag;



double hight_target,dis_x_target,dis_y_target,line_dis_target=200;
...
void keep_openmv_dis_x(void)
{
	my_give_vel_x = (openmv_dis_x_target-openmv_dis_x)*keep_openmv_xy_Kp;
	my_give_vel_x = Limit_max_int(my_give_vel_x,20);
}

void keep_openmv_dis_y(void)
{
	my_give_vel_y = (openmv_dis_y_target-openmv_dis_y)*keep_openmv_xy_Kp;
	my_give_vel_y = Limit_max_int(my_give_vel_y,20);
}
...
{
	if(Task_time_dly_cnt_ms<ms){Task_time_dly_cnt_ms+=50;}
