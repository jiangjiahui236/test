	...
	//判断第6通道拨杆位置 1700<CH_6<2200 
		...
		if(one_key_mission_f==1)
		{
			...
			switch(mission_step)
			{
				...
				case 7://回正完成
				{
					if(((dis_yaw_target-yaw)>-3)&&((dis_yaw_target-yaw)<3)) {mission_step++;keep_yaw_flag=0;}
				}break;
...
//				case 13:
//				{
//					if((OpenMV_pole_error>-3)&&(OpenMV_pole_error<3)) {mission_step++;OpenMV_mode=0;around_pole_flag=0;}
//				}break;
				
				
				case 13:
				{
					User_Task_Delay(100000);
				}break;
