...
//////////////////////////////////////////全流程/////////////////////////////////////////////////////////		
				...
				case 14://检测条形码
				{
					if(receive_OpenMV_mode==2) {mission_step++;keep_core_flag=1;}
				}break;
				...
				case 15:
				{
					...
					keep_y_flag=0;
					beep_flag=1;
					if((OpenMV_core_x<30)&&(OpenMV_core_x>-30)) cnt++; else cnt=0;
					if(cnt>=20) {cnt=0;keep_core_flag=0;mission_step++;}
				}break;
				...
				{
					OpenMV_mode=3;
					if(receive_OpenMV_mode==4) {beep_flag=0;dis_y_target-=300;keep_y_flag=1;OpenMV_mode=1;mission_step++;}
				}break;
				...
				case 19:
				{
					if(receive_OpenMV_mode==1) {beep_flag=1;mission_step++;dis_y_target=dis_y;dis_x_target=dis_x;keep_x_flag=0;}
				}break;
...
///////////////////////////////////////////////////////////////////////////////////////////
				...
				case 21:
				{
					if((OpenMV_pole_error>-30)&&(OpenMV_pole_error<30)) cnt++; else cnt=0;
					if(cnt>5){cnt=0;mission_step++;}
				}break;
				...
				case 22:
				{
					OpenMV_mode=6;
					dis_y_target=dis_y;
					if(receive_OpenMV_mode==4) {beep_flag=0;mission_step++;OpenMV_mode=1;}
				}break;
