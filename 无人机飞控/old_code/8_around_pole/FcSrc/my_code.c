...
int line_patro_flag,keep_x_flag,keep_y_flag,keep_yaw_flag,keep_pole_flag,keep_line_dis_flag,around_pole_flag;
...
//		OpenMV_pole_error-=160;
	...
	if(receive_OpenMV_mode==0) OpenMV_pole_error=0;
