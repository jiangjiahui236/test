...
//		if((rc_in.rc_ch.st_data.ch_[ch_6_aux2]>800 && rc_in.rc_ch.st_data.ch_[ch_6_aux2]<1200))//////////////////////////////////////////////
					if((rc_in.rc_ch.st_data.ch_[ch_6_aux2]>800 && rc_in.rc_ch.st_data.ch_[ch_6_aux2]<1200)&&(car_data_0==11||car_data_0==22))//////////////////////////////////////////////
...
//		if((car_data_0==11||car_data_0==22))
...
//					if(find_fire_flag==0&&(fire_x-radar_data_1>-40&&fire_x-radar_data_1<40&&fire_y-radar_data_2>-40&&fire_y-radar_data_2<40))//到达火源////////////////////////////////////////
					if(car_data_0==22&&find_fire_flag==0&&(fire_x-radar_data_1>-40&&fire_x-radar_data_1<40&&fire_y-radar_data_2>-40&&fire_y-radar_data_2<40))//到达火源////////////////////////////////////////
					mission_step=20;					
				...
				case 13:{
					...
					else mission_step++;//到达目标11后
				}break;
				case 14:{hight_target=10;if(hight<20)mission_step=999;}break;
...
//					if(cnt>=25){mission_step++;cnt=0;}
					mode_select(4);//选择飞行模式
					dis_x_target=fire_x;dis_y_target=fire_y;;beep_bsp(1);rgb_flag=1;
				...
				case 24:{task_see=23;beep_bsp(0);rgb_flag=0;new_fire_x=radar_data_1;new_fire_y=radar_data_2;Send_fire_flag=0;mode_select(4);hight_target=150;find_fire_flag=1;mission_step=11;}break;
				...
				//一键降落
				case 999:{task_see=999;mode_select(0);OneKey_Land();}break;
				default:break;
			}
		}
		else
