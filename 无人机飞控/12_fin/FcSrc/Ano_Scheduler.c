...
static void Loop_50Hz(void) //20ms执行一次
{
	...
	new_fire_x=90;new_fire_y=60;
	if(Send_fire_flag||KEY_2)MY_urst1_Send_fire();
	else MY_urst1_Send_xy();///////////////////////////////////////////////////////////////////////////////////////////////
...
static void Loop_2Hz(void) //500ms执行一次
{
	...
	if(servo_flag)TIM_SetCompare1(TIM4,175);
	else TIM_SetCompare1(TIM4,195);
	//////////////////////////////////////////////////////////////////////
}
//////////////////////////////////////////////////////////////////////
//调度器初始化
