...
{
	u8 end=0x0A+7+radar_data_1/10+radar_data_2/10;
	u8 Buf[]={0x0A,7,radar_data_1/10,radar_data_2/10,end};
...
{
	u8 end=0x0A+8+new_fire_x/10+new_fire_y/10;
	u8 Buf[]={0x0A,8,new_fire_x/10,new_fire_y/10,end};
