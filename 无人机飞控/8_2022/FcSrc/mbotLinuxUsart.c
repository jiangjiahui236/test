...
//					printf("Received data check sum error!");
			...
			case 3://接收信息尾
				...
				else if (k==1)
				{
					...
					////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					//速度赋值操作
					radar_data_1  = (int)leftVelSet.d;
					radar_data_2 = (int)rightVelSet.d;
					radar_data_3 = receiveBuff[7];                //buf[7]			
					
					
					radar_data_3=42;
//					if(radar_data_3==42&&radar_wait_time<=100)
//					{
//						//前馈控制，补正雷达，推算未来数据
...
//					}
					...
					{
						//光流坐标系修正
						dis_x_zore_fix=dis_x-(int)(radar_data_1/10.0);
						dis_y_zore_fix=dis_y-(int)(radar_data_2/10.0);
					}
					radar_wait_time=0;
					////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					//ctrlFlag
