...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10|GPIO_Pin_11;		//µÚ6 7¸ùÒý½Å
}
...
void my_oled_show(void)
{
	u8 s[]="test";
	OLED_ShowString(5,1,s,4);
	int a=456;
	OLED_ShowNum(40,1,a,3,6);
}
