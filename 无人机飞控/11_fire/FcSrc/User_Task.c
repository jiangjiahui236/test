...
//					if(cnt>=25){mission_step++;cnt=0;}
				...
				case 21:{task_see=21;
					hight_target=100;
				if(hight<120&&hight>80){mission_step++;}break;
				}
				case 22:{User_Task_Delay(3000);}break;
				case 23:{task_see=23;beep_bsp(0);rgb_flag=0;new_fire_x=radar_data_1;new_fire_y=radar_data_2;Send_fire_flag=1;mode_select(4);hight_target=150;find_fire_flag=1;mission_step=11;}break;
