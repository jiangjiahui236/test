...
/*****************************************************************/
typedef struct{
  float pitch,roll,yaw,last_yaw; 		//欧拉角
	short aacx,aacy,aacz;		//加速度传感器原始数据
	short gyrox,gyroy,gyroz;	//陀螺仪原始数据
  short temp;					//温度
	int8_t round_flag;	//圈数
}pose_TypeDef;

extern pose_TypeDef pose;
extern float yaw;

void get_imu_data(void);  //获取欧拉角，加速度，角速度和温度
void MPU_Init(void);	//陀螺仪初始化
//void MPU9250_pid_Cale(uint8_t T);
